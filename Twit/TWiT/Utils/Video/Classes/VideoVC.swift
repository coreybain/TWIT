...
class VideoVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var minimizeButton: VideoPopupCloseButton!
    ...
    func initViews() {
        ...
        let gesture = UIPanGestureRecognizer.init(target: self, action: #selector(VideoVC.panAction(_:)))
...
////        cell.labelArtist.text = videos[(indexPath as NSIndexPath).row].artist
////        cell.labelTitle.text = videos[(indexPath as NSIndexPath).row].name
...
//        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        VideoPlayer.playIndex((indexPath as NSIndexPath).row)
    }
