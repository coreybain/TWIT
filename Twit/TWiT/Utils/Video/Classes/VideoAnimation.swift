    ...
    func minimizeViews() {
        ...
        UIView.animate(withDuration: 0.5, delay: 0.0, options: .curveEaseOut, animations: {
            ...
            self.transparentView?.alpha = 0.0
                ...
                self.playerTapGesture = UITapGestureRecognizer(target: self, action: #selector(VideoVC.expandViews))
    ...
    func expandViews() {
        UIView.animate(withDuration: 0.5, delay: 0.0, options: .curveEaseIn, animations: {
            ...
            self.transparentView?.alpha = 1.0
                ...
                self.playerTapGesture = nil
                self.playerTapGesture = UITapGestureRecognizer(target: self, action: #selector(VideoVC.showPlayerControls))
                self.playerView.addGestureRecognizer(self.playerTapGesture!)
