    ...
    func parseShow(data:FIRDataSnapshot, complete:([TwitShowDetails]) -> ()) {
        ...
        for show in showData {
            ...
            if showHero != nil || showCover != nil {
                twitShow = TwitShowDetails(label: label, showID: ID, description: description, active: active, shortCode: shortCode, showContactInfo: nil, showDate: showDate, tagline: tagLine, showHeroImage: showHero, showCoverImage: showCover, categoryID: nil, categoryLabel: nil, topicsID: nil, topicsLabel: nil, twitCastDetails: twitCastDict)
            } else if showHero != nil {
                twitShow = TwitShowDetails(label: label, showID: ID, description: description, active: active, shortCode: shortCode, showContactInfo: nil, showDate: showDate, tagline: tagLine, showHeroImage: showHero, showCoverImage: nil, categoryID: nil, categoryLabel: nil, topicsID: nil, topicsLabel: nil, twitCastDetails: twitCastDict)
            } else if showCover != nil {
                twitShow = TwitShowDetails(label: label, showID: ID, description: description, active: active, shortCode: shortCode, showContactInfo: nil, showDate: showDate, tagline: tagLine, showHeroImage: nil, showCoverImage: showCover, categoryID: nil, categoryLabel: nil, topicsID: nil, topicsLabel: nil, twitCastDetails: twitCastDict)
            } else {
                twitShow = TwitShowDetails(label: label, showID: ID, description: description, active: active, shortCode: shortCode, showContactInfo: nil, showDate: showDate, tagline: tagLine, showHeroImage: nil, showCoverImage: nil, categoryID: nil, categoryLabel: nil, topicsID: nil, topicsLabel: nil, twitCastDetails: twitCastDict)
            }
    ...
    func parseEpisode(data:FIRDataSnapshot, complete:([TwitEpisodeDetails]) -> ()) {
        ...
        for recent in recentData {
            ...
            if videoArray.count != 0 {
                twitEpisode = TwitEpisodeDetails(label: label, ID: ID, created: created, episodeNumber: episodeNumber, showNotes: showNotes, showLabel: showLabel, showPicture: showPicture, videoArray: videoArray)
                print(label)
                print(showLabel)
                twitParseEpisodeDict.append(twitEpisode!)
            } else {
                twitEpisode = TwitEpisodeDetails(label: label, ID: ID, created: created, episodeNumber: episodeNumber, showNotes: showNotes, showLabel: showLabel, showPicture: showPicture, videoArray: nil)
                print(label)
                print(showLabel)
                twitParseEpisodeDict.append(twitEpisode!)
            }
